...
- **Live POI Search**: Deep integration with the Geoapify Places API filters venues precisely within the overlapping bounds of all users.
...
- `/src/scripts/app.js`: The application brain (MapLibre init, DOM events, Geoapify API integrations).
...
- **Geoapify Places API**: Live geographic node and POI querying.
